...
export const sendEmailResetPWDSchema = z.object({
  email: z.string().email('Deve passar um email'),
});
...
export type tResetPWDEmail = z.infer<typeof sendEmailResetPWDSchema>;
export type tResePWD = z.infer<typeof resetPWDSchema>;
