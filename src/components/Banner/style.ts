...
const BannerColorStyle = styled.section`
  height: 285px;
  width: 100%;
...
const SellerDataSquareStyle = styled.div`
  height:  550px;
  width: max(80%, 300px);
...
const FirstLettersSquareStyle = styled.div`
  height: 104px;
  width: 104px;
...
const AdvertiserStyle = styled.div`
  height: auto;
  width: min(250px, 100%);
...
export { 
  BannerImageStyle, BannerColorStyle,
  BackgroundGradientStyle, SellerDataSquareStyle,
  TextStyle, FirstLettersSquareStyle,
  AdvertiserStyle
};
